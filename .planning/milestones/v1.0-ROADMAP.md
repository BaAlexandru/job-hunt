...
- [ ] **Phase 9: Frontend Integration Polish** - Gap closure: interview notes contract, timeline UI, document category, route guard, dead code cleanup
...
**Goal**: Close integration gaps found during milestone audit -- fix frontend-backend contract mismatches, wire missing UI features, verify route protection, and remove dead code
**Depends on**: Phase 8
**Requirements**: INTV-03, INTV-04, DOCS-05, AUTH-02
**Gap Closure**: Closes INT-01, INT-02, INT-03, INT-04, and degraded proxy.ts flow from v1.0-MILESTONE-AUDIT.md
**Success Criteria** (what must be TRUE):
  ...
  5. No dead/unused hooks remain in the frontend codebase (useApplicationTransitions removed)
**Plans:** 2 plans

Plans:
- [ ] 09-01-PLAN.md -- Interview notes Page unwrapping fix, document category selector, route guard verification, dead code removal
- [ ] 09-02-PLAN.md -- Timeline hook field mapping, TimelineTab component, wiring into application detail panel
...
| 9. Frontend Integration Polish | 0/2 | Not started | - |
